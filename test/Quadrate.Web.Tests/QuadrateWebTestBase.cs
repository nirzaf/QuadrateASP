...
{
    public abstract class QuadrateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static QuadrateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(QuadrateWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<QuadrateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<QuadrateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<QuadrateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<QuadrateDbContext, Task<T>> func)
        {
            T result;
